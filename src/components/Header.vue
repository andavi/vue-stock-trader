            ...
            <nav class="navbar navbar-default">
                <div class="container-fluid">
                    <div class="navbar-header">
                        <router-link to="/" tag="a" class="navbar-brand" active-class="active"><span class="glyphicon glyphicon-usd"></span><span style="font-weight: 400">tock Trader</span></router-link>
                    </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a><small>Funds: {{ funds | currency }} | Assets: {{ assets | currency }} | Net: {{ funds + assets | currency }} <span class="glyphicon glyphicon-signal"></span></small></a></li>
                    </ul>
                </div>
            </nav>
        </div>
