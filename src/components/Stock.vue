        ...
        <div class="panel" :class="[company.price > 0 ? 'panel-success' : 'panel-danger']">
            <div class="panel-heading">
                <div class="panel-title">
                    <span style="font-weight: 500">{{ company.name }}</span> <span
                        style="font-size: 60%">(Price: {{ company.price }})</span>
                </div>
            </div>
            <div class="panel-body">
                ...
                <form class="form-inline" v-else>
                    <div class="form-group">
                        <input type="number" id="deadinput" class="form-control bg-danger" placeholder="Bankrupt"
                               disabled>
                    </div>
                    <button
                            type="submit"
